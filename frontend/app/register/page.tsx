    ...
    <div className="min-h-screen bg-[#0a0a0f] flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md">
        ...
        <div className="bg-gray-900 border border-gray-800 rounded-xl shadow-2xl p-8">
          ...
          <button
            type="button"
            className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-gray-800 border border-gray-700 rounded-lg font-medium text-gray-300 hover:border-gray-500 hover:text-gray-100 transition-all"
          >
