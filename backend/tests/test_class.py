...
class TestClassModel:
    ...
    def test_create_class(self, db_session, teacher_user):
        ...
        retrieved_class = db_session.query(Class).filter_by(id=test_class.id).first()
    ...
    def test_class_created_at_auto_set(self, db_session, teacher_user):
    ...
    def test_class_description_optional(self, db_session, teacher_user):
    ...
    def test_class_teacher_relationship(self, db_session, teacher_user, test_class):
    ...
    def test_teacher_taught_classes_relationship(self, db_session, teacher_user):
    ...
    def test_class_requires_teacher_id(self, db_session):
    ...
    def test_class_name_required(self, db_session, teacher_user):
    ...
    def test_cascade_delete_classes(self, db_session, teacher_user):
        ...
        # Delete the teacher
        db_session.delete(teacher_user)
        db_session.commit()

        # Classes should be deleted too
        remaining_classes = (
            db_session.query(Class).filter_by(teacher_id=teacher_id).all()
        )
        assert len(remaining_classes) == 0

    def test_class_query_by_teacher(self, db_session, teacher_user):
        ...
        classes = db_session.query(Class).filter_by(teacher_id=teacher_user.id).all()
