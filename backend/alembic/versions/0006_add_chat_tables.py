...
Revision ID: 0006_add_chat_tables
Revises: 0005_add_document_chunks
Create Date: 2026-03-04 14:06:00.000000
...
def upgrade() -> None:
    ...
    op.create_index("ix_chat_sessions_class_id", "chat_sessions", ["class_id"], unique=False)
